...
- <a id="practice-consistency-across-team-repos"></a>**How one practice lives in several team repos and stays consistent** —
  ...
  **And the evidence against re-declaring, which is the part this item most
  ...
  [`loader-comment-names-an-unvendored-check`](TODO.md#loader-comment-names-an-unvendored-check)'s
...
- <a id="coverage-report-for-registered-checks"></a>**Have the very deep check
  ...
  **This produces the count
  [`provenance-check-skips-in-a-source-set`](TODO.md#provenance-check-skips-in-a-source-set)
...
95. <a id="applies-to-sprawl"></a>**The path-trigger channel prints a wall of
