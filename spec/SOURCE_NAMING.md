...
|---|---|---|---|---|
| 1 | The GitHub repository name (`<owner>/precedent-team-writing`) | people, browsing | nothing breaks immediately; a later rename breaks every vendored reference | **Recommended**, and disclosed before anyone picks one |
