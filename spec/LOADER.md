...
| | |
|---|---|
| Practices in the catalogue | 110 |
| Resident, loaded every session | 10 of 110 practices |
| Resident block size | ≈949 tokens of a 2000-token hard cap |
| `## Rule` share of the catalogue | 19% of the catalogue |
| Rules still over 150 words | 34 |
| Carrying a `## Detail` | 73 |
| Carrying a `## Story` | 110 |
| Enforced by a check | 46 of 110 practices carry a `checked_by` |
<!--/gen:catalogue-->
