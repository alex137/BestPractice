...
| | |
|---|---|
| Practices in the catalogue | 91 |
| Resident, loaded every session | 10 of 91 practices |
...
| Carrying a `## Detail` | 51 |
| Carrying a `## Story` | 91 |
| Enforced by a check | 41 of 91 practices carry a `checked_by` |
<!--/gen:catalogue-->
