...
| | |
|---|---|
| Practices in the catalogue | 138 |
| Resident, loaded every session | 10 of 138 practices |
...
| Carrying a `## Detail` | 96 |
| Carrying a `## Story` | 138 |
| Enforced by a check | 49 of 138 practices carry a `checked_by` |
<!--/gen:catalogue-->
