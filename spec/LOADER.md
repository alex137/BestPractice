...
| | |
|---|---|
| Practices in the catalogue | 125 |
| Resident, loaded every session | 11 of 125 practices |
...
| Carrying a `## Story` | 125 |
| Enforced by a check | 47 of 125 practices carry a `checked_by` |
<!--/gen:catalogue-->
