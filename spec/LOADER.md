...
| | |
|---|---|
| Practices in the catalogue | 80 |
| Resident, loaded every session | 8 of 80 practices |
...
| Carrying a `## Detail` | 39 |
| Carrying a `## Story` | 80 |
| Enforced by a check | 38 of 80 practices carry a `checked_by` |
<!--/gen:catalogue-->
