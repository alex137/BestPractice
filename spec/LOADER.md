...
| | |
|---|---|
| Practices in the catalogue | 136 |
| Resident, loaded every session | 12 of 136 practices |
...
| Carrying a `## Detail` | 94 |
| Carrying a `## Story` | 136 |
| Enforced by a check | 49 of 136 practices carry a `checked_by` |
<!--/gen:catalogue-->
