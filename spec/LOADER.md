...
| | |
|---|---|
| Practices in the catalogue | 120 |
| Resident, loaded every session | 10 of 120 practices |
...
| Carrying a `## Story` | 120 |
| Enforced by a check | 47 of 120 practices carry a `checked_by` |
<!--/gen:catalogue-->
