...
| | |
|---|---|
| Practices in the catalogue | 145 |
| Resident, loaded every session | 11 of 145 practices |
| Resident block size | ≈1045 tokens of a 2000-token hard cap |
| `## Rule` share of the catalogue | 23% of the catalogue |
| Rules still over 150 words | 63 |
| Carrying a `## Detail` | 102 |
| Carrying a `## Story` | 145 |
| Enforced by a check | 50 of 145 practices carry a `checked_by` |
<!--/gen:catalogue-->
