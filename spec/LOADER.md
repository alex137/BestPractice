...
| | |
|---|---|
| Practices in the catalogue | 81 |
| Resident, loaded every session | 9 of 81 practices |
| Resident block size | ≈655 tokens of a 2000-token hard cap |
| `## Rule` share of the catalogue | 18% of the catalogue |
| Rules still over 150 words | 19 |
| Carrying a `## Detail` | 40 |
| Carrying a `## Story` | 81 |
| Enforced by a check | 38 of 81 practices carry a `checked_by` |
<!--/gen:catalogue-->
