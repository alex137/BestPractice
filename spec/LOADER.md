...
| | |
|---|---|
| Practices in the catalogue | 109 |
| Resident, loaded every session | 10 of 109 practices |
...
| Carrying a `## Detail` | 72 |
| Carrying a `## Story` | 109 |
| Enforced by a check | 46 of 109 practices carry a `checked_by` |
<!--/gen:catalogue-->
