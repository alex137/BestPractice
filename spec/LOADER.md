...
| | |
|---|---|
| Practices in the catalogue | 127 |
| Resident, loaded every session | 11 of 127 practices |
...
| Carrying a `## Detail` | 88 |
| Carrying a `## Story` | 127 |
| Enforced by a check | 47 of 127 practices carry a `checked_by` |
<!--/gen:catalogue-->
