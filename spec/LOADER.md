...
| | |
|---|---|
| Practices in the catalogue | 115 |
| Resident, loaded every session | 10 of 115 practices |
| Resident block size | ≈949 tokens of a 2000-token hard cap |
| `## Rule` share of the catalogue | 20% of the catalogue |
| Rules still over 150 words | 38 |
| Carrying a `## Detail` | 78 |
| Carrying a `## Story` | 115 |
| Enforced by a check | 46 of 115 practices carry a `checked_by` |
<!--/gen:catalogue-->
