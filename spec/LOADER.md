...
| | |
|---|---|
| Practices in the catalogue | 105 |
| Resident, loaded every session | 10 of 105 practices |
...
| Carrying a `## Detail` | 67 |
| Carrying a `## Story` | 105 |
| Enforced by a check | 46 of 105 practices carry a `checked_by` |
<!--/gen:catalogue-->
