...
| | |
|---|---|
| Practices in the catalogue | 82 |
| Resident, loaded every session | 9 of 82 practices |
...
| Carrying a `## Detail` | 41 |
| Carrying a `## Story` | 82 |
| Enforced by a check | 38 of 82 practices carry a `checked_by` |
<!--/gen:catalogue-->
