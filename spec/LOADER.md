...
| | |
|---|---|
| Practices in the catalogue | 68 |
| Resident, loaded every session | 7 of 68 practices |
...
| Carrying a `## Detail` | 29 |
| Carrying a `## Story` | 68 |
| Enforced by a check | 34 of 68 practices carry a `checked_by` |
<!--/gen:catalogue-->
