...
| | |
|---|---|
| Practices in the catalogue | 78 |
| Resident, loaded every session | 8 of 78 practices |
...
| Carrying a `## Detail` | 37 |
| Carrying a `## Story` | 78 |
| Enforced by a check | 38 of 78 practices carry a `checked_by` |
<!--/gen:catalogue-->
