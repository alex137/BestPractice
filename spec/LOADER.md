...
| | |
|---|---|
| Practices in the catalogue | 107 |
| Resident, loaded every session | 10 of 107 practices |
...
| Carrying a `## Detail` | 70 |
| Carrying a `## Story` | 107 |
| Enforced by a check | 46 of 107 practices carry a `checked_by` |
<!--/gen:catalogue-->
