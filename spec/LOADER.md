...
| | |
|---|---|
| Practices in the catalogue | 131 |
| Resident, loaded every session | 11 of 131 practices |
| Resident block size | ≈1180 tokens of a 2000-token hard cap |
| `## Rule` share of the catalogue | 23% of the catalogue |
| Rules still over 150 words | 55 |
| Carrying a `## Detail` | 91 |
| Carrying a `## Story` | 131 |
| Enforced by a check | 48 of 131 practices carry a `checked_by` |
<!--/gen:catalogue-->
