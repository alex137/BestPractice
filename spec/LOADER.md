...
| | |
|---|---|
| Practices in the catalogue | 85 |
| Resident, loaded every session | 9 of 85 practices |
| Resident block size | ≈655 tokens of a 2000-token hard cap |
| `## Rule` share of the catalogue | 18% of the catalogue |
| Rules still over 150 words | 21 |
| Carrying a `## Detail` | 44 |
| Carrying a `## Story` | 85 |
| Enforced by a check | 38 of 85 practices carry a `checked_by` |
<!--/gen:catalogue-->
