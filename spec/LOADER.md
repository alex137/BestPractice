...
| | |
|---|---|
| Practices in the catalogue | 99 |
| Resident, loaded every session | 10 of 99 practices |
...
| Carrying a `## Detail` | 60 |
| Carrying a `## Story` | 99 |
| Enforced by a check | 46 of 99 practices carry a `checked_by` |
<!--/gen:catalogue-->
