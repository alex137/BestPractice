...
| | |
|---|---|
| Practices in the catalogue | 66 |
| Resident, loaded every session | 6 of 66 practices |
...
| Carrying a `## Detail` | 27 |
| Carrying a `## Story` | 66 |
| Enforced by a check | 34 of 66 practices carry a `checked_by` |
<!--/gen:catalogue-->
