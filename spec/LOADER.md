...
| | |
|---|---|
| Practices in the catalogue | 144 |
| Resident, loaded every session | 10 of 144 practices |
...
| Carrying a `## Detail` | 101 |
| Carrying a `## Story` | 144 |
| Enforced by a check | 50 of 144 practices carry a `checked_by` |
<!--/gen:catalogue-->
