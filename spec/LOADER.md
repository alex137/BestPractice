...
| | |
|---|---|
| Practices in the catalogue | 134 |
| Resident, loaded every session | 11 of 134 practices |
...
| Carrying a `## Story` | 134 |
| Enforced by a check | 49 of 134 practices carry a `checked_by` |
<!--/gen:catalogue-->
