...
| | |
|---|---|
| Practices in the catalogue | 139 |
| Resident, loaded every session | 10 of 139 practices |
...
| Carrying a `## Detail` | 97 |
| Carrying a `## Story` | 139 |
| Enforced by a check | 49 of 139 practices carry a `checked_by` |
<!--/gen:catalogue-->
