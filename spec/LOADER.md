...
| | |
|---|---|
| Practices in the catalogue | 130 |
| Resident, loaded every session | 11 of 130 practices |
...
| Carrying a `## Story` | 130 |
| Enforced by a check | 47 of 130 practices carry a `checked_by` |
<!--/gen:catalogue-->
