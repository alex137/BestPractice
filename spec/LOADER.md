...
| | |
|---|---|
| Practices in the catalogue | 147 |
| Resident, loaded every session | 11 of 147 practices |
...
| Carrying a `## Story` | 147 |
| Enforced by a check | 51 of 147 practices carry a `checked_by` |
<!--/gen:catalogue-->
