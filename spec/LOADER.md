...
| | |
|---|---|
| Practices in the catalogue | 92 |
| Resident, loaded every session | 10 of 92 practices |
...
| Carrying a `## Detail` | 52 |
| Carrying a `## Story` | 92 |
| Enforced by a check | 41 of 92 practices carry a `checked_by` |
<!--/gen:catalogue-->
