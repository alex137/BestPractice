...
| | |
|---|---|
| Practices in the catalogue | 142 |
| Resident, loaded every session | 10 of 142 practices |
...
| Carrying a `## Detail` | 100 |
| Carrying a `## Story` | 142 |
| Enforced by a check | 49 of 142 practices carry a `checked_by` |
<!--/gen:catalogue-->
