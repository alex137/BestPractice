...
[spawn-session](https://github.com/alex137/BestPractice/blob/precedent-beta-v01/practices/session-text.md)'s
...
[spawn-session](https://github.com/alex137/BestPractice/blob/precedent-beta-v01/practices/session-text.md)
...
- **The tag namespaces**, [practices/session-tags.md](../practices/session-tags.md) —
  ...
  and wired into [spawn-session](../practices/session-text.md), which is the
